    ...
    @objc func addButtontapped() {
        ...
        Task {
            do {
                ...
                if let gfError = error as? GFError {
                    presentGFAlert(title: "Sommething went wrong", message: gfError.rawValue, buttonTitle: "Ok")
                } else {
                    presentDefaultError()
                }
        ...
        PersistenceManger.updateWith(favorite: favorite, actionType: .add) { [weak self] error in
            ...
            guard let error = error else {
                DispatchQueue.main.async {
                    self.presentGFAlert(title: "Success!", message: "You have successfully favorited this user 🎉.", buttonTitle: "Hoooray!")
                }
                return
            }
            DispatchQueue.main.async {
                self.presentGFAlert(title: "Sommething", message: error.rawValue, buttonTitle: "Ok")
            }
        }
    }
}
